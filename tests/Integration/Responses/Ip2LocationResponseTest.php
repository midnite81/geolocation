...
it('can construct correctly with free response', function () {
    ...
    expect($response)
        ...
        ->and($response->continent)->toBeNull()
        ->and($response->country)->toBeNull()
        ->and($response->region)->toBeNull()
        ->and($response->city)->toBeNull()
        ->and($response->timeZoneInfo)->toBeNull()
        ->and($response->geoTargeting)->toBeNull()
        ->and($response->adsCategory)->toBeNull()
        ->and($response->adsCategoryName)->toBeNull()
        ->and($response->isProxy)->toBeFalse()
        ->and($response->proxy)->toBeNull();
});
